...
# Token used by the Flask webhook endpoint for verification
WEBHOOK_VERIFY_TOKEN = os.getenv("WEBHOOK_VERIFY_TOKEN", "mySecretToken737")
...
# Scheduler settings
# Run the job once per day at 06:00 by default
POST_SCHEDULE = os.getenv("POST_SCHEDULE", "0 6 * * *")
